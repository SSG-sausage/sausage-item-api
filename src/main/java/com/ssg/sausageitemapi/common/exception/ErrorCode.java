...
import static com.ssg.sausageitemapi.common.exception.ErrorStatusCode.BAD_GATEWAY;
import static com.ssg.sausageitemapi.common.exception.ErrorStatusCode.BAD_REQUEST;
import static com.ssg.sausageitemapi.common.exception.ErrorStatusCode.CONFLICT;
import static com.ssg.sausageitemapi.common.exception.ErrorStatusCode.FORBIDDEN;
import static com.ssg.sausageitemapi.common.exception.ErrorStatusCode.INTERNAL_SERVER;
import static com.ssg.sausageitemapi.common.exception.ErrorStatusCode.NOT_FOUND;
import static com.ssg.sausageitemapi.common.exception.ErrorStatusCode.SERVICE_UNAVAILABLE;
import static com.ssg.sausageitemapi.common.exception.ErrorStatusCode.UNAUTHORIZED;
...
public enum ErrorCode {
    ...
    NOT_FOUND_PRODUCT_EXCEPTION(NOT_FOUND, "존재하지 않는 상품입니다."),
